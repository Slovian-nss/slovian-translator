...
const languageData = [
    { code: 'slo', slo: 'Slověnьsky', pl: 'Słowiański', en: 'Slovian (Slavic)', de: 'Slawisch', ru: 'Славянский', fr: 'Slave', es: 'Eslavo' },
    { code: 'en', slo: "Angol'ьsky", pl: 'Angielski', en: 'English', de: 'Englisch', ru: 'Английский', fr: 'Anglais', es: 'Inglés' },
    { code: 'pl', slo: "Pol'ьsky", pl: 'Polski', en: 'Polish', de: 'Polnisch', ru: 'Польский', fr: 'Polonais', es: 'Polaco' },
    { code: 'de', slo: 'Nemьčьsky', pl: 'Niemiecki', en: 'German', de: 'Deutsch', ru: 'Немецкий', fr: 'Allemand', es: 'Alemán' },
    { code: 'cs', slo: 'Češьsky', pl: 'Czeski', en: 'Czech', de: 'Tschechisch', ru: 'Чешский', fr: 'Tchèque', es: 'Checo' },
    { code: 'sk', slo: 'Slovačьsky', pl: 'Słowacki', en: 'Slovak', de: 'Slowakisch', ru: 'Словацкий', fr: 'Slovaque', es: 'Eslovaco' },
    { code: 'ru', slo: 'Rusьsky', pl: 'Rosyjski', en: 'Russian', de: 'Russisch', ru: 'Русский', fr: 'Russe', es: 'Ruso' },
    { code: 'uk', slo: 'Ukrajinьsky', pl: 'Ukraiński', en: 'Ukrainian', de: 'Ukrainisch', ru: 'Украинский', fr: 'Ukrainien', es: 'Ucraniano' },
    { code: 'fr', slo: 'Franьsky', pl: 'Francuski', en: 'French', de: 'Französisch', ru: 'Французский', fr: 'Français', es: 'Francés' },
    { code: 'es', slo: 'Španьsky', pl: 'Hiszpański', en: 'Spanish', de: 'Spanisch', ru: 'Испанский', fr: 'Espagnol', es: 'Español' },
    { code: 'it', slo: 'Volšьsky', pl: 'Włoski', en: 'Italian', de: 'Italienisch', ru: 'Итальянский', fr: 'Italien', es: 'Italiano' },
    { code: 'af', slo: 'Južьnozemьsky', pl: 'Afrikaans', en: 'Afrikaans', de: 'Afrikaans', ru: 'Африкаанс', fr: 'Afrikaans', es: 'Afrikaans' },
    { code: 'sq', slo: 'Albanьsky', pl: 'Albański', en: 'Albanian', de: 'Albanisch', ru: 'Албанский', fr: 'Albanais', es: 'Albanés' },
    { code: 'ar', slo: 'Arabьsky', pl: 'Arabski', en: 'Arabic', de: 'Arabisch', ru: 'Арабский', fr: 'Arabe', es: 'Árabe' },
    { code: 'hy', slo: 'Armenьsky', pl: 'Ormiański', en: 'Armenian', de: 'Armenisch', ru: 'Армянский', fr: 'Arménien', es: 'Armenio' },
    { code: 'az', slo: "Azerbed'ěnьsky", pl: 'Azerbejdżański', en: 'Azerbaijani', de: 'Aserbaidschanisch', ru: 'Азербайджанский', fr: 'Azerbaïdjanais', es: 'Azerbaiyano' },
    { code: 'eu', slo: 'Baskьsky', pl: 'Baskijski', en: 'Basque', de: 'Baskisch', ru: 'Баскский', fr: 'Basque', es: 'Vasco' },
    { code: 'be', slo: 'Bělorusьsky', pl: 'Białoruski', en: 'Belarusian', de: 'Weißrussisch', ru: 'Белорусский', fr: 'Biélorusse', es: 'Bielorruso' },
    { code: 'bn', slo: 'Bengalьsky', pl: 'Bengalski', en: 'Bengali', de: 'Bengalisch', ru: 'Бенгальский', fr: 'Bengali', es: 'Bengalí' },
    { code: 'bs', slo: 'Bosnьsky', pl: 'Bośniacki', en: 'Bosnian', de: 'Bosnisch', ru: 'Боснийский', fr: 'Bosniaque', es: 'Bosnio' },
    { code: 'bg', slo: "Boulgar'ьsky", pl: 'Bułgarski', en: 'Bulgarian', de: 'Bulgarisch', ru: 'Болгарский', fr: 'Bulgare', es: 'Búlgaro' },
    { code: 'ca', slo: "Katalonьsky", pl: 'Kataloński', en: 'Catalan', de: 'Katalanisch', ru: 'Каталанский', fr: 'Catalan', es: 'Catalán' },
    { code: 'zh-CN', slo: 'Kitajьsky (Uproščeny)', pl: 'Chiński (upr)', en: 'Chinese (Simp)', de: 'Chin (Ver)', ru: 'Китайский (упр)', fr: 'Chinois (Simp)', es: 'Chino (Simp)' },
    { code: 'hr', slo: 'Horvatьsky', pl: 'Chorwacki', en: 'Croatian', de: 'Kroatisch', ru: 'Хорватский', fr: 'Croate', es: 'Croata' },
    { code: 'da', slo: 'Dunьsky', pl: 'Duński', en: 'Danish', de: 'Dänisch', ru: 'Датский', fr: 'Danois', es: 'Danés' },
    { code: 'nl', slo: 'Niskozemьsky', pl: 'Holenderski', en: 'Dutch', de: 'Niederländisch', ru: 'Нидерландский', fr: 'Néerlandais', es: 'Neerlandés' },
    { code: 'et', slo: 'Estonьsky', pl: 'Estoński', en: 'Estonian', de: 'Estnisch', ru: 'Эстонский', fr: 'Estonien', es: 'Estonio' },
    { code: 'fi', slo: 'Finьsky', pl: 'Fiński', en: 'Finnish', de: 'Finnisch', ru: 'Финский', fr: 'Finnois', es: 'Finlandés' },
    { code: 'ka', slo: 'Gruzinьsky', pl: 'Gruziński', en: 'Georgian', de: 'Georgisch', ru: 'Грузинский', fr: 'Géorgien', es: 'Georgiano' },
    { code: 'el', slo: 'Grečьsky', pl: 'Grecki', en: 'Greek', de: 'Griechisch', ru: 'Grečeskij', fr: 'Grec', es: 'Griego' },
    { code: 'he', slo: 'Hebrějskьsky', pl: 'Hebrajski', en: 'Hebrew', de: 'Hebräisch', ru: 'Иврит', fr: 'Hébreu', es: 'Hebreo' },
    { code: 'hi', slo: 'Hindьsky', pl: 'Hindi', en: 'Hindi', de: 'Hindi', ru: 'Хинди', fr: 'Hindi', es: 'Hindi' },
    { code: 'hu', slo: 'Ǫgrinьsky', pl: 'Węgierski', en: 'Hungarian', de: 'Ungarisch', ru: 'Венгерский', fr: 'Hongrois', es: 'Húngaro' },
    { code: 'is', slo: 'Ledozemьsky', pl: 'Islandzki', en: 'Icelandic', de: 'Isländisch', ru: 'Исландский', fr: 'Islandais', es: 'Islandés' },
    { code: 'id', slo: 'Indonezijьsky', pl: 'Indonezyjski', en: 'Indonesian', de: 'Indonesisch', ru: 'Индонезийский', fr: 'Indonésien', es: 'Indonesio' },
    { code: 'ja', slo: 'Japonьsky', pl: 'Japoński', en: 'Japanese', de: 'Japanisch', ru: 'Японский', fr: 'Japonais', es: 'Japonés' },
    { code: 'ko', slo: 'Koreanьsky', pl: 'Koreański', en: 'Korean', de: 'Koreanisch', ru: 'Корейский', fr: 'Coréen', es: 'Coreano' },
    { code: 'la', slo: 'Latinьsky', pl: 'Łacina', en: 'Latin', de: 'Latein', ru: 'Латынь', fr: 'Latin', es: 'Latín' },
    { code: 'lv', slo: 'Latyšьsky', pl: 'Łotewski', en: 'Latvian', de: 'Lettisch', ru: 'Латышский', fr: 'Letton', es: 'Letón' },
    { code: 'lt', slo: 'Litovьsky', pl: 'Litewski', en: 'Lithuanian', de: 'Litauisch', ru: 'Литовский', fr: 'Lituanien', es: 'Lituano' },
    { code: 'no', slo: 'Norvežьsky', pl: 'Norweski', en: 'Norwegian', de: 'Norwegisch', ru: 'Норвежский', fr: 'Norvégien', es: 'Noruego' },
    { code: 'pt', slo: "Portugal'ьsky", pl: 'Portugalski', en: 'Portuguese', de: 'Portugiesisch', ru: 'Португальский', fr: 'Portugais', es: 'Portugués' },
    { code: 'ro', slo: "Rumunьsky", pl: 'Rumuński', en: 'Romanian', de: 'Rumänisch', ru: 'Румынский', fr: 'Roumain', es: 'Rumano' },
    { code: 'sr', slo: 'Sirbьsky', pl: 'Serbski', en: 'Serbian', de: 'Serbisch', ru: 'Сербский', fr: 'Serbe', es: 'Serbio' },
    { code: 'sv', slo: 'Švedьsky', pl: 'Szwedzki', en: 'Swedish', de: 'Schwedisch', ru: 'Шведский', fr: 'Suédois', es: 'Sueco' },
    { code: 'tr', slo: 'Turečьsky', pl: 'Turecki', en: 'Turkish', de: 'Türkisch', ru: 'Турецкий', fr: 'Turc', es: 'Turco' },
    { code: 'vi', slo: 'Větnamьsky', pl: 'Wietnamski', en: 'Vietnamese', de: 'Vietnamesisch', ru: 'Вьетнамский', fr: 'Vietnamien', es: 'Vietnamita' },
    { code: 'zu', slo: 'Zulu', pl: 'Zuluski', en: 'Zulu', de: 'Zulu', ru: 'Зулу', fr: 'Zoulou', es: 'Zulú' }
    // Należy dopisać pozostałe kody: am, fa, sw, ta, te, ur itd. w tym samym formacie.
];
